...
@require_sentencepiece
@require_tokenizers
class GemmoeTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = GemmoeTokenizer
    rust_tokenizer_class = GemmoeTokenizerFast
    ...
    def setUp(self):
        ...
        tokenizer = GemmoeTokenizer(SAMPLE_VOCAB, keep_accents=True)
    ...
    def test_tokenizer_integration(self):
        ...
        self.tokenizer_integration_test_util(
            ...
            model_name="hf-internal-testing/dummy-gemmoe",
            revision="",
            padding=False,
        )
...
class GemmoeIntegrationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        checkpoint_name = "hf-internal-testing/dummy-gemmoe"
        cls.tokenizer: GemmoeTokenizer = GemmoeTokenizer.from_pretrained(
            checkpoint_name, eos_token="<s>"
        )  # add this token
        cls.rust_tokenizer = GemmoeTokenizerFast.from_pretrained(
    ...
    def test_special_token_special_word(self):
        ...
        tokenizer = GemmoeTokenizer.from_pretrained("hf-internal-testing/dummy-gemmoe")
...
class CommonSpmIntegrationTests(unittest.TestCase):
    ...
    def test_edge_case_tabulation(self):
        fast_tokenizer = GemmoeTokenizerFast.from_pretrained("hf-internal-testing/dummy-gemmoe")
        slow_tokenizer = GemmoeTokenizer.from_pretrained("hf-internal-testing/dummy-gemmoe")
        input_text = "Hey<eos>. \t\t \n\nyou  é  @#😈  🤗!       , 1234 15 5,61"
